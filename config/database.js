...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'talison', 'talison@maturana.com.br', '123', 'Talison' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'talison')
`;
...
INSERT INTO user (
    ...
    user_password,
    user_full_name
) SELECT 'maturana', 'maturana@talison.com.br', '123', 'Maturana' WHERE NOT EXISTS (SELECT * FROM user WHERE user_name = 'maturana')
`;
